...
public class Scroller
{
  ...
  public void fling(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8)
  {
    ...
    this.mMode = 1;
    this.mFinished = false;
    float f4 = FloatMath.sqrt(i * i + j * j);
    this.mVelocity = f4;
    double d = Math.log(START_TENSION * f4 / ALPHA);
    ...
    for (f4 = 1.0F;; f4 = j / f4)
    {
      ...
      this.mFinalY = (Math.round(paramInt3 * f4) + paramInt2);
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/net/simonvt/numberpicker/Scroller.class
