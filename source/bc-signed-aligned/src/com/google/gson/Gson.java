...
public final class Gson
{
    ...
    throws JsonIOException, JsonSyntaxException
  {
    ...
    //   49: aload_1
    //   50: iload 4
    //   52: invokevirtual 411	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   55: goto -16 -> 39
    //   58: new 305	com/google/gson/JsonSyntaxException
    //   61: astore_2
    //   62: aload_2
    //   63: aload 5
    //   65: invokespecial 308	com/google/gson/JsonSyntaxException:<init>	(Ljava/lang/Throwable;)V
    //   68: aload_2
    //   69: athrow
    //   70: astore_2
    //   71: aload_1
    //   72: iload 4
    //   74: invokevirtual 411	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   77: aload_2
    //   78: athrow
    //   79: astore 5
    //   81: new 305	com/google/gson/JsonSyntaxException
    //   84: astore_2
    //   85: aload_2
    //   86: aload 5
    ...
    //   92: athrow
    //   93: astore 5
    //   95: new 305	com/google/gson/JsonSyntaxException
    //   98: astore_2
    //   99: aload_2
    //   100: aload 5
    //   102: invokespecial 308	com/google/gson/JsonSyntaxException:<init>	(Ljava/lang/Throwable;)V
    //   105: aload_2
    //   106: athrow
    ...
    //   93	8	5	localIOException	IOException
    // Exception table:
    //   from	to	target	type
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> paramTypeToken)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject4 = this.factories.iterator();
        for (;;)
        {
          if (((Iterator)localObject4).hasNext())
          {
            localObject2 = ((TypeAdapterFactory)((Iterator)localObject4).next()).create(this, paramTypeToken);
            if (localObject2 != null)
            {
              localFutureTypeAdapter.setDelegate((TypeAdapter)localObject2);
        ...
        ((IllegalArgumentException)localObject4).<init>("GSON cannot handle " + paramTypeToken);
    ...
    throws JsonIOException
  {
    ...
    {
      paramJsonElement = new com/google/gson/JsonIOException;
      paramJsonElement.<init>(localIOException);
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/google/gson/Gson.class
