  ...
  static
  {
    ...
    CALENDAR = new TypeAdapter()
    {
        ...
        throws IOException
      {
        ...
        int n;
        int i1;
        for (paramAnonymousJsonReader = null;; paramAnonymousJsonReader = new GregorianCalendar(i, j, k, m, n, i1))
        {
          return paramAnonymousJsonReader;
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/google/gson/internal/bind/TypeAdapters.class
