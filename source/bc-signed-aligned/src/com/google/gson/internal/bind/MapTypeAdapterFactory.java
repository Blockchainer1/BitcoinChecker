  ...
  implements TypeAdapterFactory
{
  ...
  public <T> TypeAdapter<T> create(Gson paramGson, TypeToken<T> paramTypeToken)
  {
    ...
    for (paramGson = null;; paramGson = new Adapter(paramGson, arrayOfType[0], (TypeAdapter)localObject, arrayOfType[1], localTypeAdapter, paramTypeToken))
    {
      return paramGson;
      arrayOfType = .Gson.Types.getMapKeyAndValueTypes((Type)localObject, .Gson.Types.getRawType((Type)localObject));
      localObject = getKeyAdapter(paramGson, arrayOfType[0]);
      localTypeAdapter = paramGson.getAdapter(TypeToken.get(arrayOfType[1]));
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/google/gson/internal/bind/MapTypeAdapterFactory.class
