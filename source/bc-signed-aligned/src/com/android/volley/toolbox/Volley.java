...
public class Volley
{
  ...
  public static RequestQueue newRequestQueue(Context paramContext, HttpStack paramHttpStack)
  {
    ...
    try
    {
      ...
      paramContext.<init>(String.valueOf(str));
      paramContext = "/" + localPackageInfo.versionCode;
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/android/volley/toolbox/Volley.class
