  ...
  extends ViewPropertyAnimator
{
  ...
  public long getDuration()
  {
    android.view.ViewPropertyAnimator localViewPropertyAnimator = (android.view.ViewPropertyAnimator)this.mNative.get();
    if (localViewPropertyAnimator != null) {}
    for (long l = localViewPropertyAnimator.getDuration();; l = -1L) {
      return l;
    }
  }
  ...
  public long getStartDelay()
  {
    android.view.ViewPropertyAnimator localViewPropertyAnimator = (android.view.ViewPropertyAnimator)this.mNative.get();
    if (localViewPropertyAnimator != null) {}
    for (long l = localViewPropertyAnimator.getStartDelay();; l = -1L) {
      return l;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/nineoldandroids/view/ViewPropertyAnimatorICS.class
