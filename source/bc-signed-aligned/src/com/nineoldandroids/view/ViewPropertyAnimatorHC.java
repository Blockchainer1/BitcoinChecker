    ...
    implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener
  {
    ...
    public void onAnimationUpdate(ValueAnimator paramValueAnimator)
    {
      ...
      if (localObject != null)
      {
        ...
        for (int j = 0; j < i; j++)
        {
          paramValueAnimator = (ViewPropertyAnimatorHC.NameValuesHolder)((ArrayList)localObject).get(j);
          float f2 = paramValueAnimator.mFromValue;
          float f3 = paramValueAnimator.mDeltaValue;
          ViewPropertyAnimatorHC.this.setValue(paramValueAnimator.mNameConstant, f2 + f3 * f1);
        }
      }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/nineoldandroids/view/ViewPropertyAnimatorHC.class
