  ...
  extends Market
{
  ...
  static
  {
    CURRENCY_PAIRS.put("BTC", new String[] { "CLP" });
  }
  
  public ChileBit()
  {
    super("ChileBit.net", "Chile Bit", CURRENCY_PAIRS);
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardian/model/market/ChileBit.class
