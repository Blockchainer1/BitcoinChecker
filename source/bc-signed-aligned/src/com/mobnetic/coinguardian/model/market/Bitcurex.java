  ...
  extends Market
{
  ...
  static
  {
    CURRENCY_PAIRS.put("BTC", new String[] { "PLN", "EUR" });
  }
  
  public Bitcurex()
  {
    super("Bitcurex", "Bitcurex", CURRENCY_PAIRS);
  }
  ...
  {
    return String.format("https://bitcurex.com/api/%1$s/ticker.json", new Object[] { paramCheckerInfo.getCurrencyCounterLowerCase() });
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardian/model/market/Bitcurex.class
