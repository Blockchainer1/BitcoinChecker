...
public class Cryptsy
  extends Market
{
  private static final HashMap<String, Integer> CURRENCY_PAIRS_IDS = new HashMap(151);
  ...
  static
  {
    ...
    CURRENCY_PAIRS_IDS.put("QRK_LTC", Integer.valueOf(126));
    ...
    CURRENCY_PAIRS_IDS.put("SBC_LTC", Integer.valueOf(128));
    ...
    CURRENCY_PAIRS_IDS.put("TGC_BTC", Integer.valueOf(130));
    ...
    CURRENCY_PAIRS_IDS.put("ZET_LTC", Integer.valueOf(127));
  }
  
  public Cryptsy()
  {
    super("Cryptsy", "Cryptsy", null);
  }
  
  public String getCurrencyPairsUrl(int paramInt)
  {
    return "https://cryptsy.com/api/v2/markets";
  }
  ...
  public String getUrl(int paramInt, CheckerInfo paramCheckerInfo)
  {
    ...
    {
      str = String.format("%1$s_%2$s", new Object[] { paramCheckerInfo.getCurrencyBase(), paramCheckerInfo.getCurrencyCounter() });
      if (!CURRENCY_PAIRS_IDS.containsKey(str)) {}
    }
    for (paramCheckerInfo = String.format("https://cryptsy.com/api/v2/markets/%1$s", new Object[] { String.valueOf(CURRENCY_PAIRS_IDS.get(str)) });; paramCheckerInfo = String.format("https://cryptsy.com/api/v2/markets/%1$s", new Object[] { paramCheckerInfo.getCurrencyPairId() })) {
    ...
    throws Exception
  {
    ...
    if (paramInt < paramJSONObject.length())
    {
      ...
      Object localObject = localJSONObject.getString("label");
      if (localObject == null) {}
      for (;;)
      {
        paramInt++;
        ...
        if ((localObject.length == 2) && (localObject[0] != null) && (localObject[1] != null)) {
          paramList.add(new CurrencyPairInfo(localObject[0], localObject[1], localJSONObject.getString("id")));
        }
      }
    }
  }
  ...
  {
    if (paramCheckerInfo.getCurrencyPairId() == null) {}
    for (paramString = "Perform sync and re-add this Checker";; paramString = super.parseError(paramInt, paramString, paramCheckerInfo)) {
      return paramString;
    }
  }
  ...
  protected void parseTickerFromJsonObject(int paramInt, JSONObject paramJSONObject, Ticker paramTicker, CheckerInfo paramCheckerInfo)
    throws Exception
  {
    paramCheckerInfo = paramJSONObject.getJSONObject("data");
    paramJSONObject = paramCheckerInfo.getJSONObject("24hr");
    paramTicker.high = paramJSONObject.getDouble("price_high");
    paramTicker.low = paramJSONObject.getDouble("price_low");
    paramTicker.last = paramCheckerInfo.getJSONObject("last_trade").getDouble("price");
  }
}


/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardian/model/market/Cryptsy.class
