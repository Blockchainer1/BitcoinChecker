  ...
  extends Market
{
  ...
  static
  {
    CURRENCY_PAIRS.put("BTC", new String[] { "USD", "HKD", "EUR", "CAD", "AUD", "SGD", "JPY", "CHF", "GBP", "NZD" });
    CURRENCY_PAIRS.put("DOGE", new String[] { "BTC", "USD", "HKD", "EUR", "CAD", "AUD", "SGD", "JPY", "CHF", "GBP", "NZD" });
    CURRENCY_PAIRS.put("LTC", new String[] { "BTC", "USD", "HKD", "EUR", "CAD", "AUD", "SGD", "JPY", "CHF", "GBP", "NZD" });
    CURRENCY_PAIRS.put("PPC", new String[] { "BTC", "LTC", "USD", "HKD", "EUR", "CAD", "AUD", "SGD", "JPY", "CHF", "GBP", "NZD" });
    CURRENCY_PAIRS.put("NMC", new String[] { "BTC", "LTC", "USD", "HKD", "EUR", "CAD", "AUD", "SGD", "JPY", "CHF", "GBP", "NZD" });
  }
  
  public Anxpro()
  {
    super("Anxpro", "ANX Pro", CURRENCY_PAIRS);
  }
  ...
  {
    return String.format("https://anxpro.com/api/2/%1$s%2$s/money/ticker", new Object[] { paramCheckerInfo.getCurrencyBase(), paramCheckerInfo.getCurrencyCounter() });
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardian/model/market/Anxpro.class
