  ...
  extends Request<T>
{
    ...
    throws Exception
  {
    ...
    //   46: aload 8
    //   48: astore 17
    //   50: new 60	java/io/ByteArrayInputStream
    //   53: astore 18
    //   55: aload_3
    //   56: astore 14
    //   58: aload 5
    ...
    //   70: aload 18
    //   72: aload_1
    //   73: invokespecial 63	java/io/ByteArrayInputStream:<init>	([B)V
    //   76: new 65	java/util/zip/GZIPInputStream
    //   79: astore_1
    //   80: aload_1
    //   81: aload 18
    //   83: invokespecial 68	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   86: new 70	java/io/InputStreamReader
    //   89: astore_3
    //   90: aload_3
    //   91: aload_1
    //   92: invokespecial 71	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   95: new 73	java/io/BufferedReader
    //   98: astore 17
    //   100: aload 17
    //   102: aload_3
    //   103: invokespecial 76	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   106: aload_2
    //   107: astore 14
    //   109: aload 17
    //   111: invokevirtual 80	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   114: astore 16
    //   116: aload 16
    //   118: ifnull +38 -> 156
    ...
    //   148: invokevirtual 92	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   151: astore 14
    //   153: goto -44 -> 109
    //   156: aload 18
    //   158: ifnull +8 -> 166
    //   161: aload 18
    //   163: invokevirtual 95	java/io/ByteArrayInputStream:close	()V
    //   166: aload_1
    //   167: ifnull +7 -> 174
    //   170: aload_1
    //   171: invokevirtual 96	java/util/zip/GZIPInputStream:close	()V
    //   174: aload_3
    //   175: ifnull +7 -> 182
    //   178: aload_3
    //   179: invokevirtual 97	java/io/InputStreamReader:close	()V
    //   182: aload 17
    //   184: ifnull +8 -> 192
    //   187: aload 17
    //   189: invokevirtual 98	java/io/BufferedReader:close	()V
    //   192: aload 14
    //   194: areturn
    //   195: astore 18
    //   197: aload 10
    ...
    //   229: ifnull +7 -> 236
    //   232: aload_1
    //   233: invokevirtual 95	java/io/ByteArrayInputStream:close	()V
    //   236: aload 18
    //   238: ifnull +8 -> 246
    //   241: aload 18
    //   243: invokevirtual 96	java/util/zip/GZIPInputStream:close	()V
    //   246: aload 17
    //   248: ifnull +8 -> 256
    //   251: aload 17
    //   253: invokevirtual 97	java/io/InputStreamReader:close	()V
    //   256: aload 16
    //   258: ifnull +8 -> 266
    //   261: aload 16
    //   263: invokevirtual 98	java/io/BufferedReader:close	()V
    //   266: aload_3
    //   267: athrow
    //   268: astore_1
    //   269: goto -3 -> 266
  ...
  protected Response<T> parseNetworkResponse(NetworkResponse paramNetworkResponse)
  {
    for (;;)
    {
      try
      {
        ...
        paramNetworkResponse = Response.success(parseNetworkResponse(str), paramNetworkResponse);
      }
  ...
  protected abstract T parseNetworkResponse(String paramString)
    throws Exception;
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardian/volley/generic/GzipVolleyRequest.class
