...
public class MarketCurrencyPairsStore
{
  ...
  {
    return paramContext.getApplicationContext().getSharedPreferences("MARKET_CURRENCIY_PAIRS", 0);
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/mobnetic/coinguardiandatamodule/tester/util/MarketCurrencyPairsStore.class
