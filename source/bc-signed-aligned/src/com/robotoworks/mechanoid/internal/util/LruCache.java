...
public class LruCache<K, V>
{
  ...
  public void trimToSize(int paramInt)
  {
    for (;;)
    {
      ...
      Object localObject1 = (Map.Entry)this.map.entrySet().iterator().next();
      Object localObject3 = ((Map.Entry)localObject1).getKey();
      localObject1 = ((Map.Entry)localObject1).getValue();
      this.map.remove(localObject3);
      this.size -= safeSizeOf(localObject3, localObject1);
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/com/robotoworks/mechanoid/internal/util/LruCache.class
