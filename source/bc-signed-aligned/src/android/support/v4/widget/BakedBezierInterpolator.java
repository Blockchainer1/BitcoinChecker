  ...
  public float getInterpolation(float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        paramFloat = VALUES[i] + (VALUES[(i + 1)] - VALUES[i]) * paramFloat;
      }
    }
  }
}
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/widget/BakedBezierInterpolator.class
