  ...
  private void setupAnimators()
  {
    ...
    Animation local1 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        f4 = localRing.getStartingRotation();
        localRing.setRotation(f2 + (f1 - f4) * paramAnonymousFloat);
    ...
    Animation local3 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        localRing.setEndTrim(f2 + f5 * (0.8F - f1));
        f2 = MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(paramAnonymousFloat);
        localRing.setStartTrim(f3 + 0.8F * f2);
        localRing.setRotation(f4 + 0.25F * paramAnonymousFloat);
        f4 = MaterialProgressDrawable.this.mRotationCount / 5.0F;
        MaterialProgressDrawable.this.setRotation(144.0F * paramAnonymousFloat + 720.0F * f4);
      }
    };
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/widget/MaterialProgressDrawable.class
