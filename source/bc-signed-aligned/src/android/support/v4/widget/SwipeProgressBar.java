  ...
  void draw(Canvas paramCanvas)
  {
    ...
    if ((this.mRunning) || (this.mFinishTime > 0L))
    {
      ...
      if (!this.mRunning)
      {
        ...
        this.mClipRect.set(k - f2, 0.0F, k + f2, j);
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/widget/SwipeProgressBar.class
