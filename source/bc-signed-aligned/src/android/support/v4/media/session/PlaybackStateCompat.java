  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject)
  {
    ...
    for (paramObject = null;; paramObject = localPlaybackStateCompat)
    {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/session/PlaybackStateCompat.class
