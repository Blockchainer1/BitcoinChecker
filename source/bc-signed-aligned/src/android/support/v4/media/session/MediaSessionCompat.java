...
public class MediaSessionCompat
{
  ...
  public MediaSessionCompat(Context paramContext, String paramString)
  {
    ...
    for (this.mImpl = new MediaSessionImplApi21(paramContext, paramString);; this.mImpl = new MediaSessionImplBase()) {
      return;
    }
  }
  ...
  public static abstract class Callback
  {
    ...
    {
      if (Build.VERSION.SDK_INT >= 21) {}
      for (this.mCallbackObj = MediaSessionCompatApi21.createCallback(new StubApi21(null));; this.mCallbackObj = null) {
        return;
      }
    }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/session/MediaSessionCompat.class
