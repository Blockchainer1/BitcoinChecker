...
public final class MediaControllerCompat
{
    ...
    throws RemoteException
  {
    ...
    for (this.mImpl = new MediaControllerImplApi21(paramContext, paramToken);; this.mImpl = new MediaControllerImplBase()) {
      return;
    }
  }
  ...
  public MediaControllerCompat(Context paramContext, MediaSessionCompat paramMediaSessionCompat)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {}
    for (this.mImpl = new MediaControllerImplApi21(paramContext, paramMediaSessionCompat);; this.mImpl = new MediaControllerImplBase()) {
      return;
    }
  }
  ...
  public static abstract class Callback
  {
    ...
    {
      if (Build.VERSION.SDK_INT >= 21) {}
      for (this.mCallbackObj = MediaControllerCompatApi21.createCallback(new StubApi21(null));; this.mCallbackObj = null) {
        return;
      }
    }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/session/MediaControllerCompat.class
