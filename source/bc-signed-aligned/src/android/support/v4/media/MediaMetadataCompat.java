  ...
  public static MediaMetadataCompat fromMediaMetadata(Object paramObject)
  {
    ...
    for (paramObject = null;; paramObject = localObject)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localObject = (Integer)METADATA_KEYS_TYPE.get(str);
        if (localObject != null) {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/MediaMetadataCompat.class
