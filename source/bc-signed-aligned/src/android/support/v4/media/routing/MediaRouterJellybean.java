...
class MediaRouterJellybean
{
  ...
  public static List getRoutes(Object paramObject)
  {
    ...
    for (int j = 0; j < i; j++) {
      ((List)paramObject).add(localMediaRouter.getRouteAt(j));
    }
  ...
  public static final class RouteGroup
  {
    public static List getGroupedRoutes(Object paramObject)
    {
      ...
      paramObject = new ArrayList(i);
      for (int j = 0; j < i; j++) {
        ((List)paramObject).add(localRouteGroup.getRouteAt(j));
      }
      return (List)paramObject;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/routing/MediaRouterJellybean.class
