  ...
  implements Parcelable
{
  ...
  public static RatingCompat fromRating(Object paramObject)
  {
    ...
    localObject2 = newHeartRating(RatingCompatApi21.hasHeart(paramObject));
    for (;;)
    {
      ((RatingCompat)localObject2).mRatingObj = paramObject;
      break;
      localObject2 = newThumbRating(RatingCompatApi21.isThumbUp(paramObject));
      continue;
      localObject2 = newStarRating(i, RatingCompatApi21.getStarRating(paramObject));
      continue;
      localObject2 = newPercentageRating(RatingCompatApi21.getPercentRating(paramObject));
      continue;
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/media/RatingCompat.class
