  ...
  implements PreferenceManagerCompat.OnPreferenceTreeClickListener
{
  ...
  {
    if (this.mPreferenceManager == null) {}
    for (paramCharSequence = null;; paramCharSequence = this.mPreferenceManager.findPreference(paramCharSequence)) {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/preference/PreferenceFragment.class
