...
class FragmentTransitionCompat21
{
    ...
    if (paramObject4 != null) {
      paramView1.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
      {
        public boolean onPreDraw()
        {
          ...
          for (int j = 0; j < i; j++) {
            paramObject4.excludeTarget((View)paramArrayList4.get(j), false);
          }
  ...
  public static void removeTargets(Object paramObject, ArrayList<View> paramArrayList)
  {
    ...
    int i = paramArrayList.size();
    for (int j = 0; j < i; j++) {
      ((Transition)paramObject).removeTarget((View)paramArrayList.get(j));
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/app/FragmentTransitionCompat21.class
