...
public class ActivityOptionsCompat
{
  ...
  public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity paramActivity, Pair<View, String>... paramVarArgs)
  {
    ...
    for (paramActivity = new ActivityOptionsImpl21(ActivityOptionsCompat21.makeSceneTransitionAnimation(paramActivity, (View[])localObject1, (String[])localObject2));; paramActivity = new ActivityOptionsCompat()) {
      return paramActivity;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/app/ActivityOptionsCompat.class
