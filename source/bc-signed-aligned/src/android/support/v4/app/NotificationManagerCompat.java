...
public class NotificationManagerCompat
{
  ...
  public static Set<String> getEnabledListenerPackages(Context paramContext)
  {
    ...
    if ((str != null) && (!str.equals(sEnabledNotificationListeners)))
    {
      ...
      for (int j = 0; j < i; j++)
      {
        ??? = ComponentName.unflattenFromString(arrayOfString[j]);
        if (??? != null) {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/app/NotificationManagerCompat.class
