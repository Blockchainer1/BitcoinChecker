  ...
  implements Parcelable
{
  ...
  public Fragment instantiate(FragmentActivity paramFragmentActivity, Fragment paramFragment)
  {
    ...
    for (paramFragmentActivity = this.mInstance;; paramFragmentActivity = this.mInstance)
    {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/app/FragmentState.class
