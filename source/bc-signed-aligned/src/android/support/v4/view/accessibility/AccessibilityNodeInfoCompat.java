...
public class AccessibilityNodeInfoCompat
{
  ...
  public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String paramString)
  {
    ...
    for (int j = 0; j < i; j++) {
      localArrayList.add(new AccessibilityNodeInfoCompat(paramString.get(j)));
    }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/view/accessibility/AccessibilityNodeInfoCompat.class
