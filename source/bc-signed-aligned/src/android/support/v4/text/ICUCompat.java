...
public class ICUCompat
{
  ...
  static
  {
    ...
    for (IMPL = new ICUCompatImplIcs();; IMPL = new ICUCompatImplBase()) {
      return;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v4/text/ICUCompat.class
