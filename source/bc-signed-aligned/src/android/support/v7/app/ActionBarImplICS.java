  ...
  extends ActionBar
{
  ...
  {
    int i = 0;
    OnMenuVisibilityListenerWrapper localOnMenuVisibilityListenerWrapper;
    if (i < this.mAddedMenuVisWrappers.size())
    {
      localOnMenuVisibilityListenerWrapper = (OnMenuVisibilityListenerWrapper)((WeakReference)this.mAddedMenuVisWrappers.get(i)).get();
      int j;
    ...
    for (paramOnMenuVisibilityListener = localOnMenuVisibilityListenerWrapper;; paramOnMenuVisibilityListener = null) {
      return paramOnMenuVisibilityListener;
    }
  }
  ...
  ImageView getHomeActionView()
  {
    ...
    {
      Object localObject2 = this.mActivity.findViewById(16908332);
      if (localObject2 == null) {}
      do
      {
        return (ImageView)localObject1;
    ...
    for (;;)
    {
      ...
      localObject1 = this.mHomeActionView;
      break;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/app/ActionBarImplICS.class
