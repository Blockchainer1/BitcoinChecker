  ...
  extends ActionBarActivityDelegate
{
  ...
  public boolean onCreatePanelMenu(int paramInt, Menu paramMenu)
  {
    ...
    for (boolean bool = this.mActivity.superOnCreatePanelMenu(paramInt, this.mMenu);; bool = this.mActivity.superOnCreatePanelMenu(paramInt, paramMenu)) {
      return bool;
    }
  }
  ...
  {
    if ((paramInt == 0) || (paramInt == 8)) {}
    for (boolean bool = this.mActivity.superOnPreparePanel(paramInt, paramView, this.mMenu);; bool = this.mActivity.superOnPreparePanel(paramInt, paramView, paramMenu)) {
      return bool;
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/app/ActionBarActivityDelegateICS.class
