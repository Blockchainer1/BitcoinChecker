  ...
  extends ActionBar
{
  ...
  void animateToMode(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      j = 4;
      label23:
      ((ActionBarView)localObject).animateToVisibility(j);
      ...
      j = 0;
      label41:
      ((ActionBarContextView)localObject).animateToVisibility(j);
  ...
  public void setNavigationMode(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localActionBarView.setCollapsable(bool2);
      return;
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/app/ActionBarImplBase.class
