...
abstract class ActionBarActivityDelegate
{
  ...
  static ActionBarActivityDelegate createDelegate(ActionBarActivity paramActionBarActivity)
  {
    if (Build.VERSION.SDK_INT >= 20) {
      paramActionBarActivity = new ActionBarActivityDelegateApi20(paramActionBarActivity);
    }
    for (;;)
    {
      return paramActionBarActivity;
      if (Build.VERSION.SDK_INT >= 18) {
        paramActionBarActivity = new ActionBarActivityDelegateJBMR2(paramActionBarActivity);
      } else if (Build.VERSION.SDK_INT >= 16) {
        paramActionBarActivity = new ActionBarActivityDelegateJB(paramActionBarActivity);
      } else if (Build.VERSION.SDK_INT >= 14) {
        paramActionBarActivity = new ActionBarActivityDelegateICS(paramActionBarActivity);
      } else if (Build.VERSION.SDK_INT >= 11) {
        paramActionBarActivity = new ActionBarActivityDelegateHC(paramActionBarActivity);
      } else {
        paramActionBarActivity = new ActionBarActivityDelegateBase(paramActionBarActivity);
      }
    }
  }
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/app/ActionBarActivityDelegate.class
