  ...
  implements SupportMenuItem
{
  ...
  {
    View localView1 = ((MenuItem)this.mWrappedObject).getActionView();
  ...
  {
    Object localObject = (ActionProviderWrapper)((MenuItem)this.mWrappedObject).getActionProvider();
    if (localObject != null) {}
    for (localObject = ((ActionProviderWrapper)localObject).mInner;; localObject = null) {
      return (android.support.v4.view.ActionProvider)localObject;
    }
  }
  ...
  public MenuItem setVisible(boolean paramBoolean)
  {
    ...
    for (Object localObject = this;; localObject = wrappedSetVisible(paramBoolean)) {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/internal/view/menu/MenuItemWrapperICS.class
