  ...
  implements MenuView.ItemView, View.OnClickListener, View.OnLongClickListener, ActionMenuView.ActionMenuChildView
{
  ...
  public boolean onLongClick(View paramView)
  {
    ...
    if (k + m < paramView.height()) {
      ((Toast)localObject).setGravity(53, n - arrayOfInt[0] - i / 2, j);
    }
    for (;;)
    {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/internal/view/menu/ActionMenuItemView.class
