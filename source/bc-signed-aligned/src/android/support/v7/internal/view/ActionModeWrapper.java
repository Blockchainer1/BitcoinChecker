  ...
  extends android.support.v7.view.ActionMode
{
    ...
    implements android.view.ActionMode.Callback
  {
    ...
    private android.support.v7.view.ActionMode getActionModeWrapper(android.view.ActionMode paramActionMode)
    {
      ...
      for (paramActionMode = this.mLastStartedActionMode;; paramActionMode = createActionModeWrapper(this.mContext, paramActionMode)) {
...
/* Location:              /prj/BitcoinChecker/tools/dex-tools-2.1-SNAPSHOT/bc-signed-aligned-dex2jar.jar!/android/support/v7/internal/view/ActionModeWrapper.class
